function [b,onsetenv,D,cumscore] = beat2(d,sr,startbpm,tightness,doplot)
...
b = b(b < (max(find(onsetenv > oethresh))+pd/2)/sgsrate);
% .. and in the beginning
b = b(b > (min(find(onsetenv < oethresh))-pd/2)/sgsrate);
